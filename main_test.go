...
//non-conventional way of testing
/*
...
//testing output printed to the console
func Test_prompt(t *testing.T) {
	...
	//read the output of our prompt function
...
func Test_checkNumbers(t *testing.T) {
	tests := []struct {
		...
		{name: "negative", input: "-15", expected: "Negative numbers are not prime, by definition!"},
		...
		{name: "three", input: "0", expected: "0 is not prime, by definition!"},
		{name: "character", input: "f", expected: "Please enter a whole number!"},
...
func Test_readUserInput(t *testing.T) {
	...
	var stdin bytes.Buffer //this will satisfy the method of being io.Reader

	stdin.Write([]byte("1\nq\n")) //this simulates writing number 1 then enter, then q then enter
